...
#data.in <- read.table('https://raw.github.com/robertwelk/DATA607/tournamentinfo.txt', header = FALSE, sep = ",") %>% unlist() %>% str_remove_all('-')

#data.in <- read_csv('https://raw.github.com/robertwelk/DATA607/tournamentinfo.txt', header = FALSE, sep = ",") %>% unlist() %>% str_remove_all('-')

test <- read_csv('tournamentinfo.txt')
